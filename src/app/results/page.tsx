      ...
      <div className="mx-auto max-w-sm">
        ...
        <div
          ...
          <div className="mb-5 flex items-center justify-between">
            ...
            {!isPremium && (
              <span className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-[0.1em] text-white/30" style={{ fontFamily: "Inter, sans-serif" }}>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-4 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/30" style={{ fontFamily: "Inter, sans-serif" }}>
              {isPremium ? "Masculinity Score" : "Unlock to reveal"}
            </p>
          </div>
        </div>
